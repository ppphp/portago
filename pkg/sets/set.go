...
func NewSetConfig(paths []string, settings *ebuild2.Config, trees *portage.Tree)*SetConfig {
	s := &SetConfig{}
...
func LoadDefaultConfig(settings *ebuild2.Config, trees *portage.Tree) *SetConfig {
