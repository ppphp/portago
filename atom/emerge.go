...
None:
	...
	a.scheduler.call_soon(unlock_future.set_result, None)
	a._imp = None
...
func(l *_LockThread) async_unlock() {
	l._unlock()
	l.scheduler.call_soon(l._unlock_future.set_result, None)
...
None:
	...
	not
None:
	l._unlock_future.set_result(None)
}
