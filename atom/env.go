...
type configLoaderKlass struct {
	loader interface{load() (map[string][]string, map[string][]string)}
}
...
func NewConfigLoaderKlass(loader interface{load() (map[string][]string, map[string][]string)})*configLoaderKlass{
